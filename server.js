...
const routes = {
  "/tools/verify_customer": async (body, res) => {
    ...
    let matches = 0;
    if (spoken_dob && spoken_dob === CUSTOMER.dob) matches++;
    if (spoken_last4 && spoken_last4 === CUSTOMER.last4) matches++;
    if (spoken_pincode && spoken_pincode === CUSTOMER.pincode) matches++;
